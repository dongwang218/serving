...
_INCEPTIONRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='tensorflow.serving.InceptionResponse.value', index=0,
...
_INCEPTIONRESPONSE.fields_by_name['value'].has_options = True
_INCEPTIONRESPONSE.fields_by_name['value']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
import abc
